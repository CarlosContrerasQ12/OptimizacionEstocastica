...
Physical Curve("Neumman") = {3, 4, 5};
Physical Curve("Dv1") = {1};
Physical Curve("Dv2") = {2};
Physical Surface("Rect") = {1};
...
//+
Transfinite Curve {5, 3, 2, 2, 2, 4} = 11 Using Progression 1;
//+
Transfinite Curve {1, 2} = 6 Using Progression 1;
//+
Transfinite Surface {1};
//+
Transfinite Curve {1, 2} = 26 Using Progression 1;
//+
Transfinite Curve {5, 3, 4} = 51 Using Progression 1;
//+
Transfinite Surface {1} = {1, 3, 4, 5};
//+
Transfinite Curve {1, 2} = 25 Using Progression 1;
//+
Transfinite Curve {5, 4, 3} = 50 Using Progression 1;
//+
Transfinite Surface {1} = {5, 4, 3, 1};
//+
Transfinite Surface {1} = {5, 4, 3, 1};
//+
Transfinite Curve {5, 3, 1, 2, 4} = 10 Using Progression 1;
//+
Transfinite Curve {5, 3, 4} = 11 Using Progression 1;
//+
Transfinite Curve {1, 2} = 6 Using Progression 1;
//+
Transfinite Curve {5, 4, 3} = 21 Using Progression 1;
//+
Transfinite Curve {1, 2} = 11 Using Progression 1;
//+
Transfinite Surface {1} = {1, 3, 4, 5};
//+
Transfinite Curve {5, 4, 3} = 51 Using Progression 1;
//+
Transfinite Curve {1, 2} = 26 Using Progression 1;
